...
@section('content')
    <div class="page-header animate-in" style="max-width: 800px; margin: 0 auto 28px auto;">
        <div class="page-title">
            ...
            {{ __('Edit Supplier: :name', ['name' => $supplier->name]) }}
        </div>
        <div class="page-subtitle">{{ __('Update vendor contact details.') }}</div>
    </div>
    ...
    <div class="section animate-in" style="max-width: 800px; margin: 0 auto;">
        <form action="{{ route('suppliers.update', $supplier->id) }}" method="POST">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                ...
                <div>
                    <label style="display: block; font-weight: 700; color: var(--navy-dark); margin-bottom: 8px;">{{ __('Phone Number') }}</label>
