...
@section('title', __('Itemwise Sales'))

@section('content')
    <div class="page-header animate-in">
        <div class="page-title"><i class="fas fa-list"></i> {{ __('Itemwise Sales') }}</div>
        <div class="page-subtitle">{{ __('Sales by product for the selected period.') }}</div>
    </div>
        ...
        <div class="table-wrapper">
            <table class="table">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="6" style="text-align: center; color: var(--gray-500); padding: 24px;">{{ __('No sales in this period.') }}</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
