...
@section('content')
    <div class="page-header animate-in">
        <div class="page-title"><i class="fas fa-chart-line"></i> Sales Summary</div>
        <div class="page-subtitle">Daily / weekly / monthly sales. Use filters and apply to refresh.</div>
    </div>
    ...
    <div class="section animate-in">
        <h2 class="section-title"><i class="fas fa-table"></i> By period</h2>
        <div class="table-wrapper">
            <table class="table">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="4" style="text-align: center; color: var(--gray-500); padding: 24px;">No sales in this period.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
