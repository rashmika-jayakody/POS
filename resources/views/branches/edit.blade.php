...
@section('content')
    <div class="page-header animate-in" style="max-width: 800px; margin: 0 auto 28px auto;">
        <div class="page-title">
            ...
            {{ __('Edit Location: :name', ['name' => $branch->name]) }}
        </div>
        <div class="page-subtitle">{{ __('Update physical shop details and status.') }}</div>
    </div>
        ...
        <form action="{{ route('branches.update', $branch->id) }}" method="POST">
            ...
            <div style="display: grid; grid-template-columns: 1fr; gap: 20px; margin-bottom: 20px;">
                ...
                <div style="display: flex; align-items: center; gap: 10px; margin-top: 10px;">
                    ...
                    <label for="is_active" style="font-weight: 600; color: var(--gray-700);">{{ __('Location is active and operational') }}</label>
                </div>
            </div>
