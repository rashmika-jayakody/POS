...
@section('content')
    <div class="page-header animate-in" style="max-width: 900px; margin: 0 auto 28px auto;">
        ...
        <div class="page-subtitle">Create a role and assign permissions. Use lowercase letters, numbers, and underscores (e.g. warehouse_staff).</div>
    </div>
    ...
    <div class="section animate-in" style="max-width: 900px; margin: 0 auto;">
        <form action="{{ route('roles.store') }}" method="POST">
            ...
            <div style="margin-bottom: 24px;">
                <label for="name" style="display: block; font-weight: 600; color: var(--navy-dark); margin-bottom: 8px;">Role name</label>
            ...
            <div style="margin-bottom: 20px;">
                <label style="display: block; font-weight: 600; color: var(--navy-dark); margin-bottom: 12px;">Permissions</label>
