...
@section('content')
    <div class="page-header animate-in">
        <div>
            ...
            <div class="page-subtitle">Track actions by user, date and time.</div>
        </div>
    </div>
    ...
    <div class="section animate-in">
        <form method="GET" action="{{ route('activity-logs.index') }}" style="display: flex; flex-wrap: wrap; gap: 12px; align-items: flex-end; margin-bottom: 20px;">
            <div>
                <label for="user_id" style="display: block; font-size: 0.75rem; color: var(--gray-500); margin-bottom: 4px;">User</label>
            ...
            <div>
                <label for="log_type" style="display: block; font-size: 0.75rem; color: var(--gray-500); margin-bottom: 4px;">Action type</label>
            ...
            <div>
                <label for="date_from" style="display: block; font-size: 0.75rem; color: var(--gray-500); margin-bottom: 4px;">From date</label>
            ...
            <div>
                <label for="date_to" style="display: block; font-size: 0.75rem; color: var(--gray-500); margin-bottom: 4px;">To date</label>
        ...
        <div class="table-wrapper">
            <table class="table">
                ...
                <tbody>
                            ...
                            <td>
                                @if(!empty($log->properties))
                                    <details style="font-size: 0.8rem;">
                                        <summary style="cursor: pointer; color: var(--light-blue);">View</summary>
                    ...
                    @empty
                        <tr>
                            <td colspan="{{ auth()->user()->hasRole('system_owner') ? 6 : 5 }}" style="text-align: center; color: var(--gray-500); padding: 40px;">No activity logs found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
